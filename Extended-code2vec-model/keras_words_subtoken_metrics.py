...
class WordsSubtokenMetricBase(tf.metrics.Metric):
    ...
    # Returns the first prediction in topK predictions, which passes all the filters. These filters are i. checking for OOV, ii. Checking if it contains only letters
